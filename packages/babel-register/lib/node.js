...
/*istanbul ignore next*/var _cloneDeep2 = _interopRequireDefault(_cloneDeep);

var /*istanbul ignore next*/_sourceMapSupport = require("source-map-support");

/*istanbul ignore next*/var _sourceMapSupport2 = _interopRequireDefault(_sourceMapSupport);

var /*istanbul ignore next*/_cache = require("./cache");

/*istanbul ignore next*/var registerCache = _interopRequireWildcard(_cache);

var /*istanbul ignore next*/_extend = require("lodash/extend");

/*istanbul ignore next*/var _extend2 = _interopRequireDefault(_extend);

var /*istanbul ignore next*/_babelCore = require("babel-core");

/*istanbul ignore next*/var babel = _interopRequireWildcard(_babelCore);

var /*istanbul ignore next*/_each = require("lodash/each");

/*istanbul ignore next*/var _each2 = _interopRequireDefault(_each);
...
/*istanbul ignore next*/var _path2 = _interopRequireDefault(_path);
